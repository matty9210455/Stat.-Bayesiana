...
# Laa prior per (mu,log(sigma)) è IMPROPRIA, proporzionale ad una cost.
...
# portano ad algoritmi efficienti sono decisamente più alti; teoricamente,
# più è alto il rapporto di accettazione e migliore è il tasso di convergenza 
# della catena.
...
# per ottenere lo stesso MCerror; se l'ESS è piccolo, questo indica che la 
...
#errore Monte Carlo, ma batchSE è una stima MENO precisa della stima "time series"
