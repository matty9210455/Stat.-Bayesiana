...
#save(output,file='ssvs_set1.Rdata')   # we save the chain
load('ssvs_set1.Rdata')
...
##trick to see which variable has been chosen with the...
...
## It is better to read the output of as.binary in reverse order
...
##The input of the function is the model-number n and the number of 
#covariate n.cov
...
#############################
#########  Th Hard Shrinkage (HS; hard thresholding/selection shrinkage)
...
# 1*(standard deviation) length interval around the posterior mean.

#posterior of the beta parameter
