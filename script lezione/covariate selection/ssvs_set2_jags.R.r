...
#save(output,file='ssvs_set2.Rdata')   # we save the chain
load('ssvs_set2.Rdata')
...
##The input of the function is the model-number n and the number of covariate n.cov
