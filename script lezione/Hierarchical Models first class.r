...
# Dal grafico a destra, sembra che le scuole con ybar più grande (sample average) o più piccolo
#  corrispondano a numerosità piccole
# Questo si spiega perchè, a parità di media campionaria, la varianza campionaria è 
# \sigma^2/n_i: più è picolo n_i e maggiore sarà la variabilità di ybar.
...
apply(MST,2,mean)
# Questi ultimi sono molto più grandi di MCERR
